...
- target: head
- motion_labels: ['walk']
- action_labels: ['fly', 'interact', 'interact', 'hover', 'peek', 'interact', 'hold', 'continue_within_region', 'fly', 'hover', 'crawl', 'swim']
