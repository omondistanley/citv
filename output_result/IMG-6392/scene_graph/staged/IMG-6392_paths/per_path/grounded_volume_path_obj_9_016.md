# Path `grounded_volume_path_obj_9_016`
...
- grounding_evidence: {'schema': 'citv_path_grounding_evidence_v1', 'candidate_source': 'scene_grounding_index', 'entity_id': 'obj_9', 'entity_label': 'rendering', 'local_evidence_confidence': 0.4231, 'global_only': False, 'manifold_reason': 'local_or_region_open_air', 'uncertainty': [], 'contradictions': []}
- source: actor
- target: rendering
