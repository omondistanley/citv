...
try:
    from scene_understanding.pathing import traversability as _trav_mod
except Exception:
    _spec = importlib.util.spec_from_file_location("scene_understanding.pathing.traversability", _trav_path)
