...
class PipelineContext:
    ...
    caption_evidence: Optional[Dict[str, Any]] = None
    scene_affordances: Optional[Dict[str, Any]] = None
    object_affordances: Optional[Dict[str, Any]] = None
    mask_affordances: Optional[Dict[str, Any]] = None
    action_hypotheses: Optional[Dict[str, Any]] = None
