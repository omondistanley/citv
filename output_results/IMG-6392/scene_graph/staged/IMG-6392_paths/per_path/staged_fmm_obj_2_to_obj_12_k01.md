# Path `staged_fmm_obj_2_to_obj_12_k01`
...
- target: head
- motion_labels: ['walk']
- action_labels: ['fly', 'interact', 'interact', 'hover', 'peek', 'interact', 'hold', 'continue_within_region', 'fly', 'hover', 'swim', 'fly']
